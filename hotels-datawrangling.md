...
**City** hotels are more expensive than resort hotels, on average.
...
```
    ...
    ## # A tibble: 2 × 5
    ##   hotel        minadr meanadr medadr maxadr
    ##   <chr>         <dbl>   <dbl>  <dbl>  <dbl>
